...
function Modal8() {
    const Modal1 = document.querySelector('.Modal8');
    const background = document.querySelector('.Background8');
...
function Modal9() {
    const Modal1 = document.querySelector('.Modal9');
    const background = document.querySelector('.Background9');
...
function Modal10() {
    const Modal1 = document.querySelector('.Modal10');
    const background = document.querySelector('.Background10');
...
function Modal11() {
    const Modal1 = document.querySelector('.Modal11');
    const background = document.querySelector('.Background11');
